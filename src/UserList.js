...
class UserList extends Component {
  ...
  sortArray = () => {
    ...
    for (let shows in unsortedObj) {
      unsortedArray.push({
        showID: parseInt(shows),
        counter: unsortedObj[shows].counter,
      });
    }
              ...
              <div className="userListContainer">
                <div className="userListFlex">
                  ...
                  <img
                    ...
                    alt={each.name}
                  />
                  <h4 className="userCardRating">
                    Rating: {each.rating.average}
                  </h4>
                </div>
                <div className="userListBtns">
                  <button
                    onClick={this.counterFunc}
                    showid={each.id}
                    value={1}
                    className="upVoteBtn"
                  >
